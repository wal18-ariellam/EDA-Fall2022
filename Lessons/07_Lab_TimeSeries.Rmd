...
sum(is.na(BRA_complete$Temperature_C)) #summary(BRA_complete$Rainfall)
...
ggplot(BRA_complete, aes( x=Date, y=Temperature_C))+geom_line()+geom_smooth(method="lm")

ggplot(BRA_complete, aes(x=Date, y=Rainfall))+geom_line()+geom_smooth(method="lm")
...
BRA_ts_rainfall <- ts(BRA_complete$Rainfall, start = c(1985,1), frequency = 365)
BRA_ts_rainfall <- ts(BRA_complete$Rainfall, start = c(1985,1), frequency = 365)
