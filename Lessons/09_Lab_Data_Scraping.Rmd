...
gage_data1 <- read.table(theURL1,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T) 
...
nc_pop <- 
  get_acs(geography = "county",
          ...
          state = "NC",
          geometry = TRUE, key="d4ad7874c996c7a83fec0a81466309ddc07d8e22")
...
df_withdrawals <- data.frame(
                             "States" = the_states,
                             "Average Retail Price" = the_price,
                            "Net Summer Capacity" = the_capacity,
                            "Net Gen"= net_generation,
                            "Total Retail Sales"= total_retail
)
```
