...
plot_grid(temperature_boxplot + theme(legend.position="none",axis.text.x = element_text(angle = 60, hjust = 1))+ggtitle(NULL), TP_boxplot + theme(legend.position="none",axis.text.x = element_text(angle = 60, hjust = 1))+ggtitle(NULL), TN_boxplot+ theme(legend.position="none",axis.text.x = element_text(angle = 60, hjust = 1))+ggtitle(NULL), nrow = 1,align = 'h')+scale_x_discrete(drop=FALSE)
```
