...
```{r}
name <- c("Bob", "Rob", "Cob", "Gob", "Zob") #character vector
test_score <- c(5,20,8,99,60) # integer vector
pass <- c(FALSE, FALSE, FALSE, TRUE, TRUE) #logical vector
class_scores <- data.frame(name, test, pass)
